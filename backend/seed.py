...
def seed_database():
    with app.app_context():
        ...
        # Create Employee User 1 (Developer)
        ...
        # Create Employee User 2 (Product Manager)
        ...
        # Create Employee User 3 (QA Engineer)
        ...
        # Assign members to cloud portal project
        ...
        # Create Tasks for Cloud Migration Project (Active)
        t1 = Task(
            project_id=proj_cloud.id,
            assigned_to_id=pm_emp.id,
        ...
        # Overdue task to demonstrate alerts
        t4 = Task(
            project_id=proj_cloud.id,
            assigned_to_id=dev_emp.id,
        ...
        # Recalculate Project Progress percentages
